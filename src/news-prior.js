...
async function _confirm(storyText, cands, t0 = Date.now()) {
  ...
  const r = await require('./claude').classifyJSON(`ידיעה:\n"${storyText.substring(0, 500)}"\n\nמועמדים:\n${list}`, {
    ...
    system: 'אתה עורך חדשות. אילו מהמועמדים מדווחים על אותו אירוע ספציפי שבידיעה — אותם אנשים או גופים, אותו מעשה או אותה אמירה, אותו מקום — ' +
      ...
      // אמירה של אדם מול דיווח עליו — שתי ידיעות. "איזנקוט: שותפות בממשלה רק עם מפלגות שמכירות בעקרונות" סומנה "כבר ידוע" בגלל "ראשי רשויות בדואיות תומכים באיזנקוט" (16.9).
      'לא: אותו אדם בשתי ידיעות שונות — אמירה שלו מול דיווח על תמיכה בו, מינוי, סקר או ביקורת עליו. אותו שם זה לא אותו אירוע; צריך שגם המעשה או האמירה עצמם יהיו אותם. ' +
